...
```{r import}
all_auth_centers <-  read.csv2("data/udost_centr_cp1251.csv",skip=1,fileEncoding = "CP1251", colClasses = rep("character",2),col.names = c("name","address","url"),
                               as.is=T) 
